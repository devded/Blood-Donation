...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="deleteDonor.php"><i class="fas fa-user-minus"></i> Delete Donor</a>
            </li>
        </ul>
    </div>
</nav>
...
<div id="frm-cvr">
    <div class="cl-wh" id="f-mlb">Delete Information</div>
    <form action="drop.php" method="post">

        <div class="f-i-bx b2 mrg3b" id="border">
            <div class="tb">
                <div class="td icn"><i class="fas fa-id-badge"></i></div>
                <div class="td prt"><input type="text" name="id" placeholder="Donor ID"></div>
            </div>
        </div>

        
        <!--<div id="tc-bx">You agree to our <a href="#">terms and conditions</a> &amp; <a href="#">privacy policies</a>.</div>-->
        <div id="s-btn" class="mrg25t"><input type="submit" value="Delete Donor" class="b3"></div>

...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="editDonor.php"><i class="fas fa-user-edit"></i> Edit Donor</a>
            </li>
            <li class="nav-item">
...
<div id="frm-cvr">
    <div class="cl-wh" id="f-mlb">Update Information</div>
    <form action="update.php" method="post">
        ...
        <div id="s-btn" class="mrg25t"><input type="submit" value="Edit Donor" class="b3"></div>
